...
# NEW: Track answers for each question
answer_q1 = ""
answer_q2 = ""
answer_q3 = ""
...
while running:
  ...
  # NEW: Save answer based on round
  if times == 0:
    answer_q1 = answer_to_q1
  elif times == 2:
    answer_q2 = answer_to_q1
  elif times == 4:
    answer_q3 = answer_to_q1
